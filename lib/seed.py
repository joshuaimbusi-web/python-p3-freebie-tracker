...
def run_seed():
    ...
    # create tables (if Alembic hasn't created them yet this will create them)
    Base.metadata.create_all(engine)

    # clear existing (safe for a local dev DB)
    ...
    # give freebies using give_freebie (these are attached to objects; commit to persist)
